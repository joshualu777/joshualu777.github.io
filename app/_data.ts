...
export const visualProjects: Project[] = [
  { name: 'StarTales', type: 'Mobile web app', dates: 'Jun – Aug 2024', description: 'Stargazing companion combining the OpenAI API with astronomy and device APIs, informed by contextual inquiry at a local stargazing event.', tags: ['React', 'Figma', 'OpenAI API'], href: 'https://startales.onrender.com/', hrefLabel: 'Open app', additionalLinks: [{ label: 'View source', href: 'https://github.com/joshualu777/StarTales' }], image: { src: '/projects/startales.png', alt: 'StarTales home screen with Write a Story, Learn Science, and Archive options above a forest landscape.', width: 2976, height: 1538 } },
